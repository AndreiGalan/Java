...
public class Problem {
     ...
     */
    public void reach(Location start, Location end)
    {
        List<Location> path = new ArrayList<>();
        if(dfs(start, end, path) == false)
            System.out.println("It is not possible to reach from " + start.getName() + " to " + end.getName());
        else
            System.out.println("It is possible to reach from " + start.getName() + " to " + end.getName());
    }
